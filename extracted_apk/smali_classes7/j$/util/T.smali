...
.method private synthetic constructor <init>(Ljava/util/Spliterator;)V
    ...
    iput-object p1, p0, Lj$/util/T;->a:Ljava/util/Spliterator;
...
.method public static synthetic a(Ljava/util/Spliterator;)Lj$/util/Spliterator;
    ...
    iget-object p0, p0, Lj$/util/U;->a:Lj$/util/Spliterator;

    return-object p0

    :cond_1
    invoke-static {p0}, Lj$/util/L;->D(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-static {p0}, Lj$/util/L;->g(Ljava/lang/Object;)Ljava/util/Spliterator$OfPrimitive;

    move-result-object p0

    invoke-static {p0}, Lj$/util/P;->a(Ljava/util/Spliterator$OfPrimitive;)Lj$/util/S;
    ...
    invoke-direct {v0, p0}, Lj$/util/T;-><init>(Ljava/util/Spliterator;)V
...
.method public final synthetic characteristics()I
    ...
    iget-object v0, p0, Lj$/util/T;->a:Ljava/util/Spliterator;
...
.method public final synthetic equals(Ljava/lang/Object;)Z
    ...
    iget-object p1, p1, Lj$/util/T;->a:Ljava/util/Spliterator;
...
.method public final synthetic trySplit()Lj$/util/Spliterator;
    ...
    invoke-static {v0}, Lj$/util/L;->k(Ljava/util/Spliterator;)Ljava/util/Spliterator;
