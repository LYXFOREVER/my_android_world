"""
与第一版的主要区别是采用os gensis的方法来进行初始任务池生成
"""
...
def _main():
    ...
    print("本次要操作的app名为:",app_name,",请注意这个名字必须和桌面上app图标下的名字相同")
    # 读取本次要用的模型
    ...
    for i in range(20):
        try:
            ...
            # 使用新方法创建任务池
            new_task_util.create_file_in_task_pool_v5(agent_generate_task,app_name,env,retry_times=3, max_action_times=10)
            ...
            world_model = WorldModel(env=env, task_goal=str(task.goal), critic=critic, vision=vision,package_name=app_name)
