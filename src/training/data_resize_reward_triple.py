...
class SupervisedDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        all_reward_labels = torch.tensor(all_reward_labels)
        ...
        data_dict = dict(
            input_ids_goal=input_ids_goal,
            attention_mask_goal=attention_mask_goal,
...
class DataCollatorForSupervisedDataset(object):
    ...
    def __call__(self, examples):
        ...
        data_dict = {
            ...
            'reward_labels': torch.cat([example['reward_labels'] for example in examples], dim=0)
        }
