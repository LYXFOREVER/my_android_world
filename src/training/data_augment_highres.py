...
from my_qwen_vl_utils_highres import process_vision_info, process_vision_info_with_mask_highres
...
def get_image_info(image_path, min_pixel, max_pixel, point=None, mask=False, mask_prob=0.5, window_min=0.1, window_max=0.5):
    ...
    if mask:
        image_input, _ = process_vision_info_with_mask_highres(messages, mask_prob, window_min, window_max)
    else:
