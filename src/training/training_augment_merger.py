...
from training.data_augment_merger import make_supervised_data_module
...
def train():
    ...
    # 解冻 压缩模块
    # print(model)
    if hasattr(model.base_model.model, "compression"):
        print("unfreeze compression")
        for name, param in model.base_model.model.compression.named_parameters():
