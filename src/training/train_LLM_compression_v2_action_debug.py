...
from model_file.LLM_compression_v2_action_debug.modeling_qwen2vl import Qwen2VLForConditionalGeneration
from training.trainer import QwenTrainer
from training.data_resize import make_supervised_data_module
...
def train():
    ...
    # unfreeze summary tokens
    # if hasattr(model.base_model.model, "summary"):
    #     print("unfreeze summary")
    #     model.base_model.model.summary.requires_grad = True
