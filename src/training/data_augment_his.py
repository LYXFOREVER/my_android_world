...
from my_qwen_vl_utils import process_vision_info_with_resize, process_vision_info_with_mask
...
class SupervisedDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
            ...
            for idx, image_file in enumerate(image_files):
                if self.combination:
                    ...
                    if idx == len(image_files) - 1:
                        ...
                        mask_images.append(get_image_info(image_file, self.min_pixel, self.max_pixel, mask=False))
        ...
        mask_inputs = processor(text=[''], images=mask_images, videos=videos, padding=False, return_tensors='pt')
