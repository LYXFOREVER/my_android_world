...
from model_file.LLM_compression_v2_different_init_adaptivedrop.modeling_qwen2vl import Qwen2VLForConditionalGeneration
...
def train():
    ...
    if hasattr(model.base_model.model, "summary"):
        ...
        for param in model.base_model.model.summary:
            # print(param)
