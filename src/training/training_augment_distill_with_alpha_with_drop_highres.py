...
import torch
import sys
sys.path.append("/home/noah/lvyibo/Qwen2-VL-finetune-code/src")
from peft import LoraConfig, get_peft_model
import ast
from transformers import AutoProcessor, BitsAndBytesConfig, HfArgumentParser
from model_file.LLM_compression_v2_action_distill.modeling_qwen2vl import Qwen2VLForConditionalGeneration
from training.trainer import QwenTrainer
from training.data_augment_highres import make_supervised_data_module
...
def train():
    ...
    model.alpha = training_args.alpha
    model.drop_k = training_args.drop_k
    model.model.drop_k = training_args.drop_k
    print("--------------Here are params--------------")
    print(model.alpha)
    print(model.model.drop_k)
    # print(model.drop_k)
