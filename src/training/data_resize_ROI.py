...
from my_qwen_vl_utils_ import process_vision_info_with_resize, process_vision_info_with_resize_ROI
...
def get_image_info_ROI(image_path, point):
    # Using this because of process_vision_info function
    # Need to fix this in the future    
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        if "image" in sources:
            ...
            for image_file in image_files:
                ...
                # 如果image_file同时位于ROI file内
                if image_file in ROI_image_files:
                    point = ROI_points[ROI_image_files.index(image_file)]
                    images.append(get_image_info_ROI(image_file, point))
