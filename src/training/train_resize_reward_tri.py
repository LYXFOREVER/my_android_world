...
from src.model_file.Reward_qwen2vl_triple.modeling_qwen2vl import Qwen2VLForConditionalGeneration
from training.trainer import QwenTrainer
from training.data_resize_reward_triple import make_supervised_data_module
...
def train():
    ...
    if hasattr(model.base_model, "reward_mlp"):
        print("unfreeze align_stages_latent")
        for name, param in model.base_model.reward_mlp.named_parameters():
